...
<%
    String result_allProducteditProduct = request.getParameter("result");
    if("done...OK".equals(result_allProducteditProduct)){
%>
    <h3 class="alert">Product Successfully Updated!</h3>
<%}%>
<%
    if("wrong".equals(result_allProducteditProduct)){
%>
